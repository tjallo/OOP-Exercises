...
public class StreamsTest {
    ...
    private static final Integer[] PI = { 3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 2, 3, 8, 4, 6, 2, 6, 4, 3, 3,
    ...
    public void calculateTax() {
        ...
        Double result = Stream.of(prices).map((a) -> a * (1 + tax)).mapToDouble(a -> a).sum();
    ...
    public void sumStringIntegers() {
        ...
        int result = Stream.of(input).mapToInt((a) -> Integer.parseInt(a)).sum();
    ...
    public void streamOfStreams() {
        ...
        int[][] input = { { 1, 2, 3, 1 }, { 4, 5, 6 }, { 7, 7, 7, 7, 7 } };

        // Hint: Stream.of(input) is a stream of int arrays
        int result = Stream.of(input).flatMapToInt(Arrays::stream).sum();
    ...
    public void everySecondElement() {
        ...
        // Hint 3: Use Stream.collect and Collectors.toList() to turn a stream into a
        // List
        List<Integer> result = IntStream.range(0, input.size() - 1).filter((a) -> a % 2 == 0)
                .mapToObj(a -> input.get(a)).collect(Collectors.toList());
    ...
    public void testRot13() {
        ...
        String text = "Sne bhg va gur hapunegrq onpxjngref bs gur hasnfuvbanoyr "
                ...
                + "fb nznmvatyl cevzvgvir gung gurl fgvyy guvax qvtvgny jngpurf " + "ner n cerggl arng vqrn.";
    ...
    public void philosophers() {
        ...
        Map<String, String> result = philosophers.entrySet().stream().filter(x -> x.getValue().equals("Greek"))
