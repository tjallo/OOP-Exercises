...
public class Term {
    ...
    public boolean equals(Object may_be_term) {
        if (may_be_term == null || getClass() != may_be_term.getClass()) {
            ...
            return exponent == term.exponent && coefficient == term.coefficient;
        }
    }

    /**
     * A static method for converting scanner input into a term. The expected format
     * is two numbers (coef, exp) separated by whitespaces. The coef should be
     * either an integer or a decimal number. The exp is an integer.
     *
